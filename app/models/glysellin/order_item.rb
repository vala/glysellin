module Glysellin
  class OrderItem < ActiveRecord::Base
    ...
    attr_accessible :sku, :name, :df_price, :vat_rate, :bundle
    ...
    def self.create_from_product_slug slug, bundle = false
      ...
      new product.attributes.select {|k,v| @@product_attributes_for_item.include?(k)}.merge({ bundle: bundle }) if product
    end
  end
end
